        ...
        <div className="homeHeroInner container">
          <div className="homeHeroCard">
            ...
            <div className="homeHeroContent">
              ...
              <p className="homeSub">
                Registered in the United States with operations in the UAE, we connect reliable international suppliers through our UAE hub — helping retailers and
                wholesalers source fast-moving products, with clear packaging and dependable logistics.
              </p>
